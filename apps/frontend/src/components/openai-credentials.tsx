  ...
  return (
    <div className="font-inter flex flex-col gap-2 mb-5">
      <div className="text-center">
        Sign Up at{" "}
        <a href="https://platform.openai.com/docs/overview"  target="_blank" className="underline text-black">
          OpenAI Platform
        </a>{" "}
        and Provide the API key for it!
      </div>{" "}
      <label className="text-black font-bold font-kode">OpenAI API Key<span className="text-red-600">*</span></label>
